      ...
      <table className="min-w-full bg-white rounded-lg">
        ...
        <tbody className=" text-xs">
          ...
          <tr className="hover:bg-gray-100 ">
            <td className="px-6 py-4 whitespace-no-wrap ">Kalisa1</td>
            <td className="px-6 py-4 whitespace-no-wrap ">Ahmed</td>
            <td className="px-6 py-4 whitespace-no-wrap ">kalisaahmnd@gmail.com</td>
            <td className="px-6 py-4 whitespace-no-wrap ">S4MCB</td>
