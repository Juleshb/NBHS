...
function BornUpdateForm() {
    ...
    const fetchNewBorns = async () => {
        try {
            ...
            const response = await fetch(`https://nbhsbackend.onrender.com/DataCollection/API/newBorns/getSingle/${userId}`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://nbhsbackend.onrender.com/DataCollection/API/newBorns/updateRefer/${userId}`, {
                method: 'PUT',
                headers: {
