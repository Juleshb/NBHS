...
const Step1 = ({ onNext }) => {
  ...
  return (
    <div className='text-primary items-center  flex-wrap justify-center '>
      <h6 className="text-sm  font-semibold mb-12">1. Copy of Passport/National ID</h6>
      <div className=" mb-12 ">
      <input
  type="file"
  className="hidden" 
...
>
<div  htmlFor="fileInput" className="border mt-5  hover:border-white text-5xl border-primary p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full ">
